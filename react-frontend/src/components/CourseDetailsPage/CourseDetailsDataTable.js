...
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.department?.stuID}</p>
...
<Column field="department" header="Department" body={dropdownTemplate1} filter={selectedFilterFields.includes("department")} hidden={selectedHideFields?.includes("department")}  style={{ minWidth: "8rem" }} />
