...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.stuID}</p>
...
<Column field="stuID" header="StuID" body={pTemplate1} filter={selectedFilterFields.includes("stuID")} hidden={selectedHideFields?.includes("stuID")}  sortable style={{ minWidth: "8rem" }} />
